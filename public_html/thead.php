...
<div><lable>User name</label></div>
	...
	<?php } else {
		?>
		Logged in as <a href="/darksouls/account"><?php echo $_COOKIE['user']; ?></a> | <a href="/darksouls/account?action=lists">my builds</a> | <a href="/darksouls/favorites">favorites</a> | <a href="/darksouls/logout">log out</a>
