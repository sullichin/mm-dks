			...
			<div role="main" id="content">
				<div class="over analy">
					<div class="padding">
						...
						<hr class="nomargin" />
						<p>Please enter your new password.  Minimum length is 5 characters.</p>
						<hr>
						<div class="cfor">
						<?php if(isset($error)){echo $error;}?>
							...
							<?php } else {
								echo 'There was a problem processing your request. Please try clicking the reset link again, requesting a new link or contacting me <a href="mailto:monkey@mugenmonkey.com">here</a>.';
							} ?>
						</div>
						<hr>
						</div>
