...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="css/style.css<?php echo $timeasset;?>1231575" />
...
<?php include('thead.php'); ?>
					...
					<div class="padding ">
						...
						<!-- Intelligence -->
							...
							<div class="sh2 aright">
								...
								<input type="checkbox" val="1" id="2hwep" /> <lable for"2hwep">2 Hand</lable>
							</div>
							<hr class="nomargin">
  ...
  <script src="js/dat1.js<?php echo $timeasset;?>"></script>
  <script src="js/dat2.js<?php echo $timeasset;?>"></script>
  <script type="text/javascript">
  </script>
   <script src="js/wep.js<?php echo $timeasset;?>12347852"></script>
  <script>
